...
textures/battleship/bridgewindow
{
	...
	sort outerBlend
	{
		map textures/battleship/bridge_envmap.dds
		tcGen environment
		rgbGen exactVertex
		alphaGen const .25
		blendFunc blend
...
textures/battleship/bridgewindowbroken
{
	qer_editorimage textures/editorimages/bridgewindow_ed.tga
	surfaceparm glass
	surfaceparm trans
	sort outerBlend
	{
		...
		blendFunc blend
	nextbundle
		map textures/battleship/bridgewindow_mask.dds
	}
	{
		map textures/battleship/bridgewindow
		blendFunc blend
...
textures/battleship/bridgewindow2broken
{
	qer_editorimage textures/editorimages/bridgewindow2_ed.tga
	surfaceparm glass
	surfaceparm trans
